...
type GetConfigMirrorAllHandlerFunc func(GetConfigMirrorAllParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetConfigMirrorAllHandlerFunc) Handle(params GetConfigMirrorAllParams, principal interface{}) middleware.Responder {
...
type GetConfigMirrorAllHandler interface {
	Handle(GetConfigMirrorAllParams, interface{}) middleware.Responder
}
