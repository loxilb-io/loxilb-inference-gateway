...
Read-only review of `/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd`, verified HEAD `f8e6ace22f0f2262d56829e781a83e4b7075fef7` plus live WIP.
...
Evidence: [user.go:199](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/user/user.go:199), [user_util.go:411](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/user/user_util.go:411), [authz.go:82](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/authz/authz.go:82). `pkg/user/schema.go:57` has an unrestricted text username column.
...
Evidence: [auth.go:141](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/auth.go:141), [user.go:508](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/user/user.go:508), `handler/auth.go:50`.
...
Evidence: [user.go:144](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/user.go:144), `handler/user.go:37,101,113`; [user_util.go:69](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/user/user_util.go:69), `pkg/user/user.go:445`.
...
Evidence: [configure_loxilb_rest_api.go:393](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/configure_loxilb_rest_api.go:393), `handler/auth.go:47`, `handler/user.go:69`, `pkg/authz/authz.go:112`.
...
Evidence: [auth.go:267](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/auth.go:267).
...
Evidence: [oauth2.go:166](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/oauth2.go:166).
...
Evidence: [oauth2.go:133](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/oauth2.go:133), `:233`, `:313`; [oauth_user.go:71](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/user/oauth_user.go:71), `:98`.
...
Evidence: [oauth_user.go:92](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/user/oauth_user.go:92), `handler/oauth2.go:41,73`.
...
Evidence: [cors.go:49](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/cors.go:49), `common/cors.go:87`; [configure_loxilb_rest_api.go:538](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/configure_loxilb_rest_api.go:538).
...
Evidence: [service.go:416](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/aikey/service.go:416), `handler/ai_apikey.go:116`; [ratelimit.go:343](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/ratelimit/ratelimit.go:343), `pkg/loxinet/ai_gateway_dp.go:538,604`.
...
Evidence: [ai_apikey.go:233](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/ai_apikey.go:233), [apiclient.go:1849](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/loxinet/apiclient.go:1849), `pkg/aikey/service.go:714`.
...
Evidence: `pkg/aikey/service.go:475,527`; `handler/ai_apikey.go:75,93,99,244`; [common.go:154](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/common.go:154), `pkg/loxinet/apiclient.go:1861`.
...
Evidence: [cert.go:283](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/cert.go:283), `:326`; [sockproxy_ssl.c:927](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/loxilb-ebpf/common/sockproxy_ssl.c:927).
...
Evidence: [sockproxy_ssl.c:946](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/loxilb-ebpf/common/sockproxy_ssl.c:946), `:994`; `handler/cert.go:334,404`.
...
Evidence: [cert.go:137](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/cert.go:137), `:301`; `api/models/cert.go:35`; [sni.go:133](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/sni.go:133), `:223`; `sockproxy_ssl.c:660`.
...
Evidence: [ipsec.go:356](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/loxinet/ipsec.go:356).
...
Evidence: [handler/ipsec.go:79](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/ipsec.go:79), `pkg/loxinet/ipsec.go:139,215,393,676,772`.
...
Evidence: [ipsec.go:1778](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/loxinet/ipsec.go:1778), `:1323`; `handler/ipsec.go:143,449,486`.
...
Evidence: [ipsec.go:1427](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/loxinet/ipsec.go:1427), `:1441`, `:1586`, `:1626`, `:1653`; `handler/ipsec.go:629`; `pkg/loxinet/ipsec.go:538`.
...
Evidence: [pii.go:52](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/pii.go:52), [pii_detection.go:328](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/loxinet/pii_detection.go:328), `:369`, `:653`.
...
Evidence: `pkg/presidio/config.go:264,273,299`; [sockproxy_presidio.c:342](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/loxilb-ebpf/common/sockproxy_presidio.c:342); `api/models/p_i_i_url_patterns_entry.go:103`; `handler/pii.go:158,183`.
...
Evidence: [pii.go:240](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/api/restapi/handler/pii.go:240), `:265`; `pkg/presidio/stub.go:18`.
...
Evidence: [config.go:189](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/llamafirewall/config.go:189), [sockproxy_llamafirewall.c:228](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/loxilb-ebpf/common/sockproxy_llamafirewall.c:228), `:456`; `pkg/loxinet/ai_security.go:186`.
...
Evidence: [sockproxy_http.c:6847](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/loxilb-ebpf/common/sockproxy_http.c:6847), `sockproxy_llamafirewall.c:210,240`.
...
Evidence: [config.go:400](/Users/gongseoghwan/go/src/loxilb-inference-gateway-ai-multitier-cicd/pkg/llamafirewall/config.go:400), `handler/llamafirewall.go:293`, `pkg/llamafirewall/config_stub.go:141`, `pkg/loxinet/ai_security.go:205`.
