...
type LBDpWorkQ struct {
	...
	ApiKeyAuth                  string                  // data-plane credential policy: "disabled" (default), "required", "jwt" or "apikey-or-jwt"
	JwtAuthProfile              string                  // JWT auth profile name for the Bearer arm (empty unless a JWT-capable mode)
