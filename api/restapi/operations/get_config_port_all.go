...
type GetConfigPortAllHandlerFunc func(GetConfigPortAllParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetConfigPortAllHandlerFunc) Handle(params GetConfigPortAllParams, principal interface{}) middleware.Responder {
...
type GetConfigPortAllHandler interface {
	Handle(GetConfigPortAllParams, interface{}) middleware.Responder
}
