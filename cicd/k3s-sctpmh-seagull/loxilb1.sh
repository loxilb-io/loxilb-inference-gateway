...
docker run -u root --cap-add SYS_ADMIN   --restart unless-stopped --privileged -dit -v /dev/log:/dev/log --net=host --name loxilb ghcr.io/loxilb-io/loxilb-inference-gateway:latest --cluster=4.0.5.11 --self=0 --ka=4.0.5.11:4.0.5.10
