...
func (m *BGPPolicyDefinitionsMod) validateStatements(formats strfmt.Registry) error {
...
func (m *BGPPolicyDefinitionsMod) contextValidateStatements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BGPPolicyDefinitionsMod) UnmarshalBinary(b []byte) error {
	var res BGPPolicyDefinitionsMod
