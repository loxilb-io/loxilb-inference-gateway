...
- **Model of record:** `Qwen/Qwen2.5-7B-Instruct` (the production-size model the NAVER
...
- **Why it lives here:** FR-4 (D-12 hash-drift oracle) hashes prompt blocks the SAME
  ...
  the block hashes and FR-4 fails LOUD rather than silently measuring round-robin
