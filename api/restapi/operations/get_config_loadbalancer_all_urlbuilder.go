...
func (o *GetConfigLoadbalancerAllURL) WithBasePath(bp string) *GetConfigLoadbalancerAllURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigLoadbalancerAllURL) Build() (*url.URL, error) {
	...
	var _path = "/config/loadbalancer/all"
...
func (o *GetConfigLoadbalancerAllURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigLoadbalancerAllURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigLoadbalancerAllURL")
	}
