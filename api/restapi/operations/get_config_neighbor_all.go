...
type GetConfigNeighborAllHandlerFunc func(GetConfigNeighborAllParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetConfigNeighborAllHandlerFunc) Handle(params GetConfigNeighborAllParams, principal interface{}) middleware.Responder {
...
type GetConfigNeighborAllHandler interface {
	Handle(GetConfigNeighborAllParams, interface{}) middleware.Responder
}
