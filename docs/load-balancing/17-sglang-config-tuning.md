...
| `kvBlockSize` | int | 16 | 1–4096 (0 ⇒ 16) | **Must equal SGLang `--page-size`** — which is *model-dependent*; read it back from `/get_server_info` (§5.2). A mismatch is **silent** (the watchdog is the tripwire) |
