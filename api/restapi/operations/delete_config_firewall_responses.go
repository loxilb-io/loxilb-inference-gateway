...
// DeleteConfigFirewallOKCode is the HTTP code returned for type DeleteConfigFirewallOK
const DeleteConfigFirewallOKCode int = 200

/*
DeleteConfigFirewallOK OK

swagger:response deleteConfigFirewallOK
*/
type DeleteConfigFirewallOK struct {
...
// NewDeleteConfigFirewallOK creates DeleteConfigFirewallOK with default headers values
func NewDeleteConfigFirewallOK() *DeleteConfigFirewallOK {

	return &DeleteConfigFirewallOK{}
}

// WithPayload adds the payload to the delete config firewall o k response
func (o *DeleteConfigFirewallOK) WithPayload(payload *models.OperationResult) *DeleteConfigFirewallOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete config firewall o k response
func (o *DeleteConfigFirewallOK) SetPayload(payload *models.OperationResult) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteConfigFirewallOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
