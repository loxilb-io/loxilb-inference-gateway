...
# tcplbmon-epstat: same testbed as tcplbmon (one L4 LB VIP with 3 monitored
# endpoints), used to assert that per-endpoint byte/packet counters survive a
# liveness-monitor state flap. See validation.sh for the regression it guards.
