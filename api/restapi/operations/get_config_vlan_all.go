...
type GetConfigVlanAllHandlerFunc func(GetConfigVlanAllParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetConfigVlanAllHandlerFunc) Handle(params GetConfigVlanAllParams, principal interface{}) middleware.Responder {
...
type GetConfigVlanAllHandler interface {
	Handle(GetConfigVlanAllParams, interface{}) middleware.Responder
}
