...
type PostConfigBgpPolicyDefinedsetsDefinesetTypeHandlerFunc func(PostConfigBgpPolicyDefinedsetsDefinesetTypeParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PostConfigBgpPolicyDefinedsetsDefinesetTypeHandlerFunc) Handle(params PostConfigBgpPolicyDefinedsetsDefinesetTypeParams, principal interface{}) middleware.Responder {
...
type PostConfigBgpPolicyDefinedsetsDefinesetTypeHandler interface {
	Handle(PostConfigBgpPolicyDefinedsetsDefinesetTypeParams, interface{}) middleware.Responder
}
