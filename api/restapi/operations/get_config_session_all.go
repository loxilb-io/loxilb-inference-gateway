...
type GetConfigSessionAllHandlerFunc func(GetConfigSessionAllParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetConfigSessionAllHandlerFunc) Handle(params GetConfigSessionAllParams, principal interface{}) middleware.Responder {
...
type GetConfigSessionAllHandler interface {
	Handle(GetConfigSessionAllParams, interface{}) middleware.Responder
}
