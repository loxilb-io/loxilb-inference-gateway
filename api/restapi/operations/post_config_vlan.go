...
type PostConfigVlanHandlerFunc func(PostConfigVlanParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PostConfigVlanHandlerFunc) Handle(params PostConfigVlanParams, principal interface{}) middleware.Responder {
...
type PostConfigVlanHandler interface {
	Handle(PostConfigVlanParams, interface{}) middleware.Responder
}
