...
for i in {1..12}; do
    echo "Test $i..."
    result=$($dexec l3h1 python3 /app/client.py http://10.10.10.254:2020/mcp health 2>&1)
    echo "$result"
...
for i in {1..3}; do
    echo "Echo test $i..."
    result=$($dexec l3h1 python3 /app/client.py http://10.10.10.254:2020/mcp echo 2>&1)
    echo "$result"
...
result=$($dexec l3h1 python3 /app/client.py http://10.10.10.254:2020/mcp models 2>&1)
echo "$result"
...
result=$($dexec l3h1 python3 /app/client.py http://10.10.10.254:2020/mcp chat 2>&1)
echo "$result"
...
result=$($dexec l3h1 python3 /app/client.py http://10.10.10.254:2020/mcp info 2>&1)
echo "$result"
...
result=$($dexec l3h1 python3 /app/client.py http://10.10.10.254:2020/mcp full 2>&1)
echo "$result"
...
for i in {1..10}; do
    echo "Persist test $i..."
    result=$($dexec l3h1 python3 /app/client.py http://10.10.10.254:2021/mcp models 2>&1)
    echo "$result"
...
if [[ $code == 0 ]]; then
    echo "#########################################"
    echo "SCENARIO-mcp-httpproxy [OK]"
    echo "#########################################"
else
    echo "#########################################"
    echo "SCENARIO-mcp-httpproxy [FAILED]"
    echo "#########################################"
fi
