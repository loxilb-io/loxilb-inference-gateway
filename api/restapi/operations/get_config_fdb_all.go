...
type GetConfigFdbAllHandlerFunc func(GetConfigFdbAllParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetConfigFdbAllHandlerFunc) Handle(params GetConfigFdbAllParams, principal interface{}) middleware.Responder {
...
type GetConfigFdbAllHandler interface {
	Handle(GetConfigFdbAllParams, interface{}) middleware.Responder
}
