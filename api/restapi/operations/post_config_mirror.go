...
type PostConfigMirrorHandlerFunc func(PostConfigMirrorParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn PostConfigMirrorHandlerFunc) Handle(params PostConfigMirrorParams, principal interface{}) middleware.Responder {
...
type PostConfigMirrorHandler interface {
	Handle(PostConfigMirrorParams, interface{}) middleware.Responder
}
